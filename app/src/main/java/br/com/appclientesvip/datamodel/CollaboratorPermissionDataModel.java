...
public class CollaboratorPermissionDataModel {
    ...
    public static final String TABELA = "collaboratorPermission";
    ...
    public static String gerarTabela(){
        ...
        query += "FOREIGN KEY("+ID_COLLABORATOR_TYPE+") REFERENCES collaborator(id), ";
